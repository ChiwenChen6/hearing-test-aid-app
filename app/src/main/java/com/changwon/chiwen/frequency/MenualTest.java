...
public class MenualTest extends AppCompatActivity {
    ...
    int frequencynumber[] = {125, 250, 500, 1000, 2000, 3000, 4000, 6000, 8000}; // 測量頻率
    public static int[] menualrealrightvalue = new int[100];      // 屏幕上每個頻率的存儲變量(RIGHT
    public static int[] menualrealleftvalue = new int[100];        // 屏幕上每個頻率的閾值存儲變量(LEFT
    int fnumber = 0;
    int maskingdB = 10;     // 環境噪音抑制
    boolean sound = true;
    boolean isPlaying = false;
    int duration = 3;
    int count = 0;
    int test = 0;
    public int[] decibel_value = new int[100];  //測試數值變量
    MediaPlayer mp        = null;
...
//        Toast.makeText(this, "menual = " + menualrealleftvalue[5], Toast.LENGTH_SHORT).show();
        ...
        lefttoggle = (Button)findViewById(R.id.lefttoggle);
        righttoggle = (Button)findViewById(R.id.righttoggle);
        frequencydown = (Button)findViewById(R.id.frequencydown);
        frequencyup = (Button)findViewById(R.id.frequencyup);
        dbdown = (Button)findViewById(R.id.dbdown);
        dbup = (Button)findViewById(R.id.dbup);
...
//        dB /= 100;
    ...
    public void decibel_list() {
        ...
        double[] l_decibel_1000_value = {0, 0.04, 0.08, 0.12, 0.16, 0.20, 0.24, 0.28, 0.32, 0.36, 0.40, 0.44, 0.48, 0.52, 0.56, 0.60, 0.64, 0.68, 0.72, 0.76, 0.80, 0.84, 0.88, 0.92, 0.96};
